...
The goal here is to save development time and gain consistency. Trying to remember the syntax for that array is annoying. Also, what happens if one developer creates a time-cast function for one site, and you need one so you go through the motions of recreating it? Not fun.
